            ...
            for _ in tqdm(range(count)):
                ...
                for i in range(3):
                    ...
                    (numold,) = struct.unpack(
                        "<I", encrypt_data[data_offset + 0x4 : data_offset + 0x4 + 4]
                    )
                ...
                (v1, v2, v3, v4, v5, v6, v7, v8) = struct.unpack(
                    "<B7sIBffff", clear_data
                )
                line = (v1, v2.rstrip(b"\x00").decode("utf-8"), v3, v4, v5, v6, v7, v8)
                result.append(line)
                data_offset += 5
