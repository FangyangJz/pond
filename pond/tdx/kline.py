...
def read_tdx_minute_kline(tdx_dir=tdx_path, market='std', symbols=[], period='1', start_date=None, end_date=None):
    kwargs = {}
...
if __name__ == "__main__":
    ...
    df = read_tdx_minute_kline(tdx_dir=r"D:\windows\programs\TongDaXin", symbols=df_stocks['代码'][:50])
    print(len(df))